...
start_purge() {
    ...
    export DXAI_CURRENT_COMMAND="purge"
...
# Show help message
show_help() {
    echo -e "${PURPLE_BOLD}dxai Purge${NC}, Clean old project build artifacts"
    echo ""
    echo -e "${YELLOW}Usage:${NC} dxai purge [options]"
    echo ""
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            *)
                ...
                echo "Use 'dxai purge --help' for usage information"
                exit 1
                ;;
        esac
    done
