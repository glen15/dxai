...
run_system_checks() {
    ...
    unset DXAI_SECURITY_FIXES_SHOWN
    unset DXAI_SECURITY_FIXES_SKIPPED
    echo ""
    ...
    if [[ "${DXAI_SECURITY_FIXES_SKIPPED:-}" != "true" ]]; then
        echo ""
    fi
...
main() {
    ...
    export DXAI_CURRENT_COMMAND="optimize"
