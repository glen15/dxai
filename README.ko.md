...
macOS 메뉴바 앱 + CLI로, AI 코딩 도구(Claude Code, Codex CLI)의 사용 현황을 한 곳에서 확인합니다.
...
```bash
dxai ai                # 토큰 사용량 대시보드 (Claude + Codex)
...
8개 등급, 36개 레벨. 디비전마다 고유 멘트. 등급 상승 및 토큰 마일스톤 달성 시 macOS 알림.
