#!/bin/bash
# Create Raycast script commands and Alfred keywords for dxai (clean + uninstall).
...
LAUNCHER_COMMAND_SPECS=(
    "clean|dxai Clean|Deep system cleanup with dxai|Run dxai clean"
    "uninstall|dxai Uninstall|Uninstall applications with dxai|Uninstall apps via dxai"
    "optimize|dxai Optimize|System health checks and optimization|System health and optimization"
    "analyze|dxai Analyze|Disk space analysis with dxai|Disk space analysis"
    "status|dxai Status|Live system status dashboard|Live system dashboard"
)
...
detect_mo() {
    if command -v mo > /dev/null 2>&1; then
        ...
        log_error "dxai not found. Install it first via Homebrew or ./install.sh."
        exit 1
    fi
}
...
create_raycast_commands() {
    ...
    for entry in "${LAUNCHER_COMMAND_SPECS[@]}"; do
        ...
        write_raycast_script "$dir/dxai-${subcommand}.sh" "$title" "$description" "$mo_bin" "$subcommand"
    done
...
main() {
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  dxai Quick Launchers"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

    local mo_bin
    mo_bin="$(detect_mo)"
    log_step "Detected dxai binary at: ${mo_bin}"
