...
struct L {
    ...
    var settingsNicknamePrivacy: String {
        ko ? "모든 데이터는 로컬에서 처리됩니다. 서버에는 닉네임과 토큰 사용량만 전송됩니다."
           : "All data is processed locally. Only your nickname and token usage are sent to the server."
    }
    ...
    var milestones: [(threshold: Int, title: String, body: String)] {
        if ko {
            return [
                (20_000_000,    "Hello, World!",              "2천만 토큰 돌파! 워밍업 완료"),
                (50_000_000,    "토큰 밀리어네어!",             "5천만 토큰! API가 비명을 지릅니다"),
                (100_000_000,   "프롬프트 장인!",               "1억 토큰! 오늘도 거침없이"),
                (150_000_000,   "Rate Limit 단골!",           "1.5억 토큰! 도저히 막을수 없습니다"),
                (200_000_000,   "Context 마스터!",             "2억 토큰! Claude가 당신을 기억합니다"),
                (300_000_000,   "API 과금 주의보!",             "3억 토큰! 멈출 수가 없다"),
                (500_000_000,   "GPU 온도 상승!",              "5억 토큰! Rate Limit이 두려워합니다"),
                (700_000_000,   "데이터센터 경보!",              "7억 토큰! Anthropic 서버실에 경보 발령"),
                (1_000_000_000, "Transformer 과부하!",         "10억 토큰! 당신의 토큰이 GDP에 잡힙니다"),
                (1_200_000_000, "학습 데이터 편입!",             "12억 토큰! AI가 당신을 학습하고 있습니다"),
                (1_400_000_000, "Sam Altman 알림!",            "14억 토큰! Context Window가 경의를 표합니다"),
                (1_600_000_000, "Dario Amodei 호출!",          "16억 토큰! 항복은 없다. Ctrl+C도 없다"),
                (1_800_000_000, "AI 특이점 접근!",              "18억 토큰! VICTORY! GG WP"),
                (2_000_000_000, "AGI 달성!",                   "20억 토큰! 당신이 곧 AGI입니다"),
            ]
        } else {
            return [
                (20_000_000,    "Hello, World!",              "20M tokens! Warm-up complete"),
                (50_000_000,    "Token Millionaire!",          "50M tokens! The API is screaming"),
                (100_000_000,   "Prompt Artisan!",             "100M tokens! Unstoppable today"),
                (150_000_000,   "Rate Limit Regular!",         "150M tokens! Absolutely unstoppable"),
                (200_000_000,   "Context Master!",             "200M tokens! Claude remembers you"),
                (300_000_000,   "API Billing Alert!",          "300M tokens! Can't stop won't stop"),
                (500_000_000,   "GPU Overheating!",            "500M tokens! Rate Limit fears you"),
                (700_000_000,   "Datacenter Alert!",           "700M tokens! Alert in Anthropic's server room"),
                (1_000_000_000, "Transformer Overload!",       "1B tokens! Your tokens show up in GDP"),
                (1_200_000_000, "Training Data Material!",     "1.2B tokens! AI is learning from you"),
                (1_400_000_000, "Sam Altman Notified!",        "1.4B tokens! Context Window bows to you"),
                (1_600_000_000, "Dario Amodei Paged!",         "1.6B tokens! No surrender. No Ctrl+C"),
                (1_800_000_000, "Approaching Singularity!",    "1.8B tokens! VICTORY! GG WP"),
                (2_000_000_000, "AGI Achieved!",               "2B tokens! You ARE the AGI"),
            ]
        }
    }
}
