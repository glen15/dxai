...
소스: ~/.hermes/state.db sessions     (Hermes 전체 유효 세션)
소스: ~/.hermes/profiles/*/state.db sessions (Hermes profile별 전체 유효 세션)
보정: ~/.codex/state_5.sqlite threads.tokens_used (native Codex 진행 중 세션)
