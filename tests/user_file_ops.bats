...
@test "ensure_user_dir creates nested directory" {
    test_dir="$HOME/.config/dxai/deep/nested/path"
    bash -c "source '$PROJECT_ROOT/lib/core/base.sh'; ensure_user_dir '$test_dir'"
    [ -d "$test_dir" ]
}
...
@test "ensure_user_file creates file and parent directories" {
    test_file="$HOME/.config/dxai/test.log"
...
@test "multiple ensure_user_file calls in same directory" {
    bash -c "source '$PROJECT_ROOT/lib/core/base.sh'
        ensure_user_file '$HOME/.config/dxai/file1.txt'
        ensure_user_file '$HOME/.config/dxai/file2.txt'
        ensure_user_file '$HOME/.config/dxai/file3.txt'
    "

    [ -f "$HOME/.config/dxai/file1.txt" ]
    [ -f "$HOME/.config/dxai/file2.txt" ]
    [ -f "$HOME/.config/dxai/file3.txt" ]
}
